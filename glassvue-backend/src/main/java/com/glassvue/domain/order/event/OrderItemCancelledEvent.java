 ...
 * ⚠ 발견 시점에 어긋난 값이 <b>없었던 것은 우연이다</b> — 상쇄돼 있었다
 * ({@code handoffs/2026-08-25} §G-10).
 *
 * <p>🔴 <b>고객 알림이 여기 붙는다</b>(§I) — 안 실으면 <b>관리자가 대신 부분 취소해도 고객에게
 * 아무 말이 없다.</b> 전체 취소는 알림이 가므로 그게 비대칭이다(반품이 2026-08-11 에 고친 것의 거울상).
