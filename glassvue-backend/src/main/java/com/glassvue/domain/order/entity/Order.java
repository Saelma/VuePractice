...
public class Order extends BaseTimeEntity {
     ...
     *
     * <p>{@code reason} 은 <b>선택</b>이라 null·공백이면 저장하지 않는다(B-17).
     * 공백만 적힌 사유를 그대로 넣으면 화면이 <b>"사유가 있다"</b> 로 읽어 빈 칸을 그린다 —
     ...
     *
     * <p>🔴 <b>{@code returnRequestedAt} 을 지우지 않는다.</b> 지우면 «반품을 요청한 적 없는
     * 배송완료 주문» 과 <b>구분이 안 된다</b> — 거절은 상태를 {@code DELIVERED} 로 되돌리므로
     * 이 시각이 «요청이 있었다» 를 나타내는 유일한 표시다. 요청 시각 + 거절 시각이 함께 있어야
     * «언제 요청해서 언제 거절됐나» 가 읽힌다({@code handoffs/2026-08-11}).
     *
