 ...
 *       <b>재고 이력의 작업자·감사 원장의 행위자·대상</b>(원장은 대상보다 오래 산다 — 2026-09-11 에 목록에 올렸다.
 *       전부터 남기고 있었는데 여기 안 적혀 «빠진 것» 과 구별이 안 됐다).
 * </ul>
 * 🔴 이 목록은 {@code MemberPurgeIntegrationTest} 가 <b>DB 의 회원 참조 칸 전체</b>와 대조한다(O-7) —
 * 새 테이블에 회원 칸을 넣으면 «지운다/남긴다» 중 하나를 고르게 된다.
 *
