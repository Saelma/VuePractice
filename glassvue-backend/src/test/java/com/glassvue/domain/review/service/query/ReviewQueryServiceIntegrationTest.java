...
class ReviewQueryServiceIntegrationTest {
    ...
    void summary() {
        ...
        save(pid, 5);
        save(pid, 4);
        ProductReviewsResponse r = queryService.getProductReviews(pid, null, false, PageRequest.of(0, 10));
    ...
    void empty() {
        ProductReviewsResponse r = queryService.getProductReviews(UUID.randomUUID(), null, false, PageRequest.of(0, 10));
